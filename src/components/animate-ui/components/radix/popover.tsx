  ...
  return (
    <PopoverPortalPrimitive>
      <PopoverContentPrimitive
        ...
        className={cn(
          "bg-popover text-popover-foreground z-50 w-72 origin-(--radix-popover-content-transform-origin) rounded-md border shadow-md outline-hidden",
          className
        )}
        {...props}
      >
        <SpiralPadPattern size={20} />
        {children}
        <SpiralPadPattern size={20} />
      </PopoverContentPrimitive>
    </PopoverPortalPrimitive>
